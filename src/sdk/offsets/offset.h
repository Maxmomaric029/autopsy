...
namespace offset {
    inline constexpr uintptr_t air_AirDensity = 0x18;
    inline constexpr uintptr_t air_GlobalWind = 0x3c;
    ...
    namespace humanoid {
        ...
        inline constexpr uintptr_t PlatformStatePointer = 0x262CF636;
    ...
    namespace world {
        ...
        inline constexpr uintptr_t GravityOverride = 0x658;
    ...
    namespace render {
        ...
        inline constexpr uintptr_t view = 0xbb0;
